...
public class RestoreableWindow {
	...
	public RestoreableWindow(Shell shell, String code) {
		this.code = code;
		this.shell = shell;
		getSizeFromShell(shell);
	}
	
	/**
	 * @param shell the shell we want to save the size
	 * @param code Code to identify the window. Note that
		...
		shell.addDisposeListener(new DisposeListener() {
			...
			public void widgetDisposed(DisposeEvent arg0) {
				...
				try {
					...
					//windDao.insert(RestoreableWindow.this);
	...
	private void getSizeFromShell(Shell shell) {
	...
	public String toString() {
		return "Restoreable window: shell=" + shell + ",x=" + x + ",y=" + y + 
